...
# module references:
# ring_buffer_FIFO, serial_tx, expo_transf_Z, neutrino_signal, noise_SiPM_neutrino, rng_pulse_trigger, signal_mux, clk_XADC_SHIFT_RAM, threshold, trig_wr_enabled
...
proc create_hier_cell_trigger_module { parentCell nameHier } {
  ...
  # Create instance: clk_XADC_SHIFT_RAM_0, and set properties
  set block_name clk_XADC_SHIFT_RAM
  set block_cell_name clk_XADC_SHIFT_RAM_0
  if { [catch {set clk_XADC_SHIFT_RAM_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $clk_XADC_SHIFT_RAM_0 eq "" } {
  ...
  if { [catch {set threshold_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.data_width {16} $threshold_0
  ...
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins clk_XADC_SHIFT_RAM_0/clk]
  connect_bd_net -net clk_XADC_SHIFT_RAM_0_clk_out [get_bd_pins clk_out] [get_bd_pins c_shift_ram_0/CLK] [get_bd_pins clk_XADC_SHIFT_RAM_0/clk_out] [get_bd_pins threshold_0/clk] [get_bd_pins trig_wr_enabled_0/clk]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins clk_XADC_SHIFT_RAM_0/aresetn] [get_bd_pins threshold_0/aresetn] [get_bd_pins trig_wr_enabled_0/aresetn]
  ...
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_pins D] [get_bd_pins c_shift_ram_0/D] [get_bd_pins threshold_0/D_in]
...
# Hierarchical cell: generacion_de_senal
proc create_hier_cell_generacion_de_senal { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_generacion_de_senal() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set out_to_ESP32 [ create_bd_port -dir O -type data out_to_ESP32 ]
  set pulse_in_0 [ create_bd_port -dir I pulse_in_0 ]
  set pulse_indicator [ create_bd_port -dir O pulse_indicator ]
  set vauxn12_0 [ create_bd_port -dir I vauxn12_0 ]
  set vauxp12_0 [ create_bd_port -dir I vauxp12_0 ]

  # Create instance: SEL, and set properties
  set SEL [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 SEL ]
  set_property -dict [list \
    CONFIG.CONST_VAL {3} \
  ...
  set XADC_ADDR [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 XADC_ADDR ]
  set_property -dict [list \
    CONFIG.CONST_VAL {28} \
  ...
  # Create instance: XADC_addr_and_mux_signal, and set properties
  set XADC_addr_and_mux_signal [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 XADC_addr_and_mux_signal ]
  set_property -dict [list \
  ...
  # Create instance: clk_ADC_104Mhz, and set properties
  set clk_ADC_104Mhz [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_ADC_104Mhz ]
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {129.027} \
    CONFIG.CLKOUT1_PHASE_ERROR {99.281} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {104} \
    CONFIG.CLKOUT2_JITTER {339.112} \
    CONFIG.CLKOUT2_PHASE_ERROR {300.278} \
  ...
  # Create instance: generacion_de_senal
  create_hier_cell_generacion_de_senal [current_bd_instance .] generacion_de_senal
...
\
  ...
  if { [catch {set serial_tx_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.baudrate {9600} $serial_tx_0


  # Create instance: thresh_level, and set properties
  set thresh_level [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 thresh_level ]
  set_property -dict [list \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins XADC_addr_and_mux_signal/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net A_1 [get_bd_pins trigger_module/A] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net SEL_dout [get_bd_pins SEL/dout] [get_bd_pins generacion_de_senal/SEL]
  connect_bd_net -net XADC_ADDR_dout [get_bd_pins XADC_ADDR/dout] [get_bd_pins xadc_wiz_0/daddr_in]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_ADC_104Mhz/clk_out1] [get_bd_pins xadc_wiz_0/dclk_in]
  connect_bd_net -net edge_sel_1 [get_bd_pins edge_sel/dout] [get_bd_pins trigger_module/edge_sel]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins XADC_addr_and_mux_signal/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_ADC_104Mhz/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ring_buffer_FIFO_0/M_AXIS_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins serial_tx_0/clk_zynq] [get_bd_pins threshold_control/s_axi_aclk] [get_bd_pins trigger_module/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net pulse_in_0_1 [get_bd_ports pulse_in_0] [get_bd_pins generacion_de_senal/pulse_in_0]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins XADC_addr_and_mux_signal/s_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins clk_ADC_104Mhz/resetn] [get_bd_pins generacion_de_senal/reset] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ring_buffer_FIFO_0/M_AXIS_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins serial_tx_0/reset] [get_bd_pins threshold_control/s_axi_aresetn] [get_bd_pins trigger_module/aresetn]
  connect_bd_net -net serial_tx_0_out_tx [get_bd_ports out_to_ESP32] [get_bd_pins serial_tx_0/out_tx]
  connect_bd_net -net serial_tx_0_serial_clk [get_bd_pins generacion_de_senal/clk] [get_bd_pins serial_tx_0/serial_clk]
  connect_bd_net -net signal_mux_0_ENABLE [get_bd_pins generacion_de_senal/ENABLE] [get_bd_pins serial_tx_0/enable_tx]
  connect_bd_net -net signal_mux_0_S_OUT [get_bd_pins generacion_de_senal/S_OUT] [get_bd_pins serial_tx_0/dato_tx]
  connect_bd_net -net thres_level_1 [get_bd_pins thresh_level/dout] [get_bd_pins trigger_module/thres_level]
  connect_bd_net -net threshold_0_led_out [get_bd_ports pulse_indicator] [get_bd_pins generacion_de_senal/pulse_indicator]
  connect_bd_net -net trigger_module_Q [get_bd_pins ila_0/probe1] [get_bd_pins ring_buffer_FIFO_0/wr_data] [get_bd_pins trigger_module/Q]
  connect_bd_net -net trigger_module_clk_out [get_bd_pins ila_0/clk] [get_bd_pins trigger_module/clk_out]
  connect_bd_net -net trigger_module_trig_wr_en [get_bd_pins ila_0/probe0] [get_bd_pins ring_buffer_FIFO_0/wr_en] [get_bd_pins trigger_module/trig_wr_en]
  connect_bd_net -net vauxn12_0_1 [get_bd_ports vauxn12_0] [get_bd_pins xadc_wiz_0/vauxn12]
  connect_bd_net -net vauxp12_0_1 [get_bd_ports vauxp12_0] [get_bd_pins xadc_wiz_0/vauxp12]
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_pins trigger_module/D] [get_bd_pins xadc_wiz_0/do_out]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xadc_wiz_0/den_in] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins trigger_module/window_len] [get_bd_pins xlconstant_2/dout]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs XADC_addr_and_mux_signal/S_AXI/Reg] -force
